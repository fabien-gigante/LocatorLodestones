...
public class MapWaypointStyleAssets {
    ...
    private static final int NEAR_DISTANCE = 4 * WaypointStyleAsset.DEFAULT_NEAR_DISTANCE;
    private static final int FAR_DISTANCE = 4 * WaypointStyleAsset.DEFAULT_FAR_DISTANCE;
